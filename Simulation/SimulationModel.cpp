...
void SimulationModel::initParameters()
{
    ...
    CLOTH_SIMULATION_METHOD = createEnumParameter("clothSimulationMethod", "Simulation method",
                                                  std::bind(&SimulationModel::getClothSimulationMethod, this),
                                                  std::bind(static_cast<void (SimulationModel::*)(const int)>(&SimulationModel::setClothSimulationMethod), this, std::placeholders::_1));
    ...
    CLOTH_BENDING_METHOD = createEnumParameter("clothBendingMethod", "Bending method",
                                               std::bind(&SimulationModel::getClothBendingMethod, this),
                                               std::bind(static_cast<void (SimulationModel::*)(const int)>(&SimulationModel::setClothBendingMethod), this, std::placeholders::_1));
    ...
    CLOTH_STIFFNESS = createNumericParameter<Real>("cloth_stiffness", "Distance constraint stiffness",
                                                   std::bind(&SimulationModel::getClothStiffness, this),
                                                   std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothStiffness), this, std::placeholders::_1));
    ...
    CLOTH_STIFFNESS_XX = createNumericParameter<Real>("cloth_xxStiffness", "Youngs modulus XX",
                                                      std::bind(&SimulationModel::getClothStiffnessXX, this),
                                                      std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothStiffnessXX), this, std::placeholders::_1));
    ...
    CLOTH_STIFFNESS_YY = createNumericParameter<Real>("cloth_yyStiffness", "Youngs modulus YY",
                                                      std::bind(&SimulationModel::getClothStiffnessYY, this),
                                                      std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothStiffnessYY), this, std::placeholders::_1));
    ...
    CLOTH_STIFFNESS_XY = createNumericParameter<Real>("cloth_xyStiffness", "Youngs modulus XY",
                                                      std::bind(&SimulationModel::getClothStiffnessXY, this),
                                                      std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothStiffnessXY), this, std::placeholders::_1));
    ...
    CLOTH_POISSON_RATIO_XY = createNumericParameter<Real>("cloth_xyPoissonRatio", "Poisson ratio XY",
                                                          std::bind(&SimulationModel::getClothPoissonRatioXY, this),
                                                          std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothPoissonRatioXY), this, std::placeholders::_1));
    ...
    CLOTH_POISSON_RATIO_YX = createNumericParameter<Real>("cloth_yxPoissonRatio", "Poisson ratio YX",
                                                          std::bind(&SimulationModel::getClothPoissonRatioYX, this),
                                                          std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothPoissonRatioYX), this, std::placeholders::_1));
    ...
    CLOTH_BENDING_STIFFNESS = createNumericParameter<Real>("cloth_bendingStiffness", "Bending stiffness",
                                                           std::bind(&SimulationModel::getClothBendingStiffness, this),
                                                           std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setClothBendingStiffness), this, std::placeholders::_1));
    ...
    CLOTH_NORMALIZE_STRETCH = createBoolParameter("cloth_normalizeStretch", "Normalize stretch",
                                                  std::bind(&SimulationModel::getClothNormalizeStretch, this),
                                                  std::bind(static_cast<void (SimulationModel::*)(const bool)>(&SimulationModel::setClothNormalizeStretch), this, std::placeholders::_1));
    ...
    CLOTH_NORMALIZE_SHEAR = createBoolParameter("cloth_normalizeShear", "Normalize shear",
                                                std::bind(&SimulationModel::getClothNormalizeShear, this),
                                                std::bind(static_cast<void (SimulationModel::*)(const bool)>(&SimulationModel::setClothNormalizeShear), this, std::placeholders::_1));
    ...
    SOLID_SIMULATION_METHOD = createEnumParameter("solidSimulationMethod", "Simulation method",
                                                  std::bind(&SimulationModel::getSolidSimulationMethod, this),
                                                  std::bind(static_cast<void (SimulationModel::*)(const int)>(&SimulationModel::setSolidSimulationMethod), this, std::placeholders::_1));
    ...
    SOLID_STIFFNESS = createNumericParameter<Real>("solid_stiffness", "Stiffness/Youngs modulus",
                                                   std::bind(&SimulationModel::getSolidStiffness, this),
                                                   std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setSolidStiffness), this, std::placeholders::_1));
    ...
    SOLID_POISSON_RATIO = createNumericParameter<Real>("solid_poissonRatio", "Poisson ratio",
                                                       std::bind(&SimulationModel::getSolidPoissonRatio, this),
                                                       std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setSolidPoissonRatio), this, std::placeholders::_1));
    ...
    SOLID_VOLUME_STIFFNESS = createNumericParameter<Real>("solid_volumeStiffness", "Volume stiffness",
                                                          std::bind(&SimulationModel::getSolidVolumeStiffness, this),
                                                          std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setSolidVolumeStiffness), this, std::placeholders::_1));
    ...
    SOLID_NORMALIZE_STRETCH = createBoolParameter("solid_normalizeStretch", "Normalize stretch",
                                                  std::bind(&SimulationModel::getSolidNormalizeStretch, this),
                                                  std::bind(static_cast<void (SimulationModel::*)(const bool)>(&SimulationModel::setSolidNormalizeStretch), this, std::placeholders::_1));
    ...
    SOLID_NORMALIZE_SHEAR = createBoolParameter("solid_normalizeShear", "Normalize shear",
                                                std::bind(&SimulationModel::getSolidNormalizeShear, this),
                                                std::bind(static_cast<void (SimulationModel::*)(const bool)>(&SimulationModel::setSolidNormalizeShear), this, std::placeholders::_1));
    ...
    ROD_STRETCHING_STIFFNESS = createNumericParameter<Real>("rod_stretchingStiffness", "Stretching stiffness/Youngs modulus",
                                                            std::bind(&SimulationModel::getRodStretchingStiffness, this),
                                                            std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setRodStretchingStiffness), this, std::placeholders::_1));
    ...
    ROD_SHEARING_STIFFNESS_X = createNumericParameter<Real>("rod_shearingStiffnessX", "Shearing stiffness x",
                                                            std::bind(&SimulationModel::getRodShearingStiffnessX, this),
                                                            std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setRodShearingStiffnessX), this, std::placeholders::_1));
    ...
    ROD_SHEARING_STIFFNESS_Y = createNumericParameter<Real>("rod_shearingStiffnessY", "Shearing stiffness y",
                                                            std::bind(&SimulationModel::getRodShearingStiffnessY, this),
                                                            std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setRodShearingStiffnessY), this, std::placeholders::_1));
    ...
    ROD_BENDING_STIFFNESS_X = createNumericParameter<Real>("rod_bendingStiffnessX", "Bending stiffness x",
                                                           std::bind(&SimulationModel::getRodBendingStiffnessX, this),
                                                           std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setRodBendingStiffnessX), this, std::placeholders::_1));
    ...
    ROD_BENDING_STIFFNESS_Y = createNumericParameter<Real>("rod_bendingStiffnessY", "Bending stiffness y",
                                                           std::bind(&SimulationModel::getRodBendingStiffnessY, this),
                                                           std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setRodBendingStiffnessY), this, std::placeholders::_1));
    ...
    ROD_TWISTING_STIFFNESS = createNumericParameter<Real>("rod_twistingStiffness", "Twisting stiffness",
                                                          std::bind(&SimulationModel::getRodTwistingStiffness, this),
                                                          std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setRodTwistingStiffness), this, std::placeholders::_1));
    ...
    CONTACT_STIFFNESS_RB = createNumericParameter<Real>("contactStiffnessRigidBody", "Contact stiffness RB",
                                                        std::bind(&SimulationModel::getContactStiffnessRigidBody, this),
                                                        std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setContactStiffnessRigidBody), this, std::placeholders::_1));
    ...
    CONTACT_STIFFNESS_PARTICLE_RB = createNumericParameter<Real>("contactStiffnessParticleRigidBody", "Contact stiffness Particle-RB",
                                                                 std::bind(&SimulationModel::getContactStiffnessParticleRigidBody, this),
                                                                 std::bind(static_cast<void (SimulationModel::*)(const Real)>(&SimulationModel::setContactStiffnessParticleRigidBody), this, std::placeholders::_1));
