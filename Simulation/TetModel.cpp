...
TetModel::TetModel() : m_surfaceMesh(),
                       m_visVertices(),
                       m_visMesh(),
                       m_particleMesh()
{
...
bool TetModel::pointInTriangle(const Vector3r &p0, const Vector3r &p1, const Vector3r &p2,
